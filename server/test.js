...
async function main() {
  ...
  try {
    ...
    response = await fetch(`${base}/api/games/peak/reports`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ message: 'Update archive fails verification.', version: '2.0' }) });
